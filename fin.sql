...
--
-- Table structure for table `duePushes`
--

DROP TABLE IF EXISTS `duePushes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `duePushes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` text NOT NULL,
  `username` text NOT NULL,
  `pushTime` double NOT NULL,
  `text` text NOT NULL,
...
CREATE TABLE `tasks` (
  ...
  `username` text NOT NULL,
  `createTime` double NOT NULL,
  `dueTime` double NOT NULL,
  `text` longtext NOT NULL,
  `done` text NOT NULL,
  `title` text NOT NULL,
  `tags` text NOT NULL,
  `pushScheduled` text NOT NULL,
  `notificationHours` int(11) NOT NULL,
...
-- Dump completed on 2017-08-22 16:25:09
